...
* [MITM-cheatsheet](#MITM-cheatsheet)
* [Red Teaming Resources](#Red-Teaming-Resources)
* [Wifi Pentest](#Wifi-Penetration-Testing)
* [Usefuls scripts and commands](#Usefuls-scripts-and-commands)
...
* [Register a free Domain/Subdomain](http://freedns.afraid.org/subdomain/edit.php) 
* [Free Email Marketing/SMS](https://phantom.ecomailapp.com/?showOnboarding) 
* [Create Online Surveys/Forms](https://www.surveymonkey.com/create/?ut_source=header) 
* [AI website builder/domain](https://app.durable.co/website/builder) 
* [webtools](https://www.webestools.com/tools.html)
...
http.proxy on
net.sniff on
tshark --print -i wlan0mon -w Desktop/outfile1
tcpdump -i wlan0mon -w Desktop/tcpdump.pcap --print
